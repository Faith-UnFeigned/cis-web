...
import { IconAdjustmentsHorizontal, IconHome, IconMaximize, IconMoon, IconSun } from '@tabler/icons-react';
    ...
    >
      {isFullscreenSupported() && (
        <Tooltip label="Presentation mode">
          <ActionIcon size={50} variant="default" onClick={togglePresentationMode}>
            <IconMaximize />
          </ActionIcon>
        </Tooltip>
      )}
      ...
      <Menu trigger="click-hover" openDelay={100} closeDelay={400} position="bottom-end">
        <Menu.Target>
          <ActionIcon size={50} variant="default">
