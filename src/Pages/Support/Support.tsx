  ...
  return (
    <Container className={styles.container}>
      ...
      <Box className={styles.main}>
        <img alt="Support us with a donation" src="/images/ic_undraw_air_support.svg" />
        <h2>Support us with a Donation!</h2>
        <div className={styles.subtext}>
          If you find this web app useful, please consider supporting us with a donation
        </div>
        <p>
          <a
        ...
        <p className={styles.disclaimer}>
          A One-time Donation or a Monthly Donation is not required to access any feature of this web app, All features
          are available for free and will always be.
