...
export default function PrivacyPolicy() {
  useDocumentTitle('Privacy Policy | Christ in Song on the Web');

  return (
    <Container
      style={{
        fontFamily: '"Sora", Verdana, Geneva, Tahoma, sans-serif',
        padding: '2em 2em 1em 2em',
      }}
    >
      <main
        style={{
          fontFamily: '"Nunito", Verdana, Geneva, Tahoma, sans-serif',
        }}
      >
        <h2>Privacy Policy</h2>
        <p>
          Tinashe Mzondiwa built the Christ In Song app as an Open Source app. This SERVICE is provided by Tinashe
          Mzondiwa at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          accessible at Christ In Song unless otherwise defined in this Privacy Policy.
        </p>
        <p>
        ...
        <p>
          ...
          identifiable information, including but not limited to applications logs. The information that I request will
        ...
        <div>
          ...
          <ul>
            <li>
              <Anchor href="https://www.google.com/policies/privacy/" target="_blank" rel="noopener noreferrer">
                Google Play Services
              </Anchor>
            </li>
            <li>
              <Anchor href="https://firebase.google.com/policies/analytics" target="_blank" rel="noopener noreferrer">
        ...
        <p>This policy is effective as of 2020-06-30</p>
        <p>
          <h2>Contact Us</h2>
        </p>
        <p>
        ...
        <p>
          ...
          <Anchor href="https://privacypolicytemplate.net" target="_blank" rel="noopener noreferrer">
