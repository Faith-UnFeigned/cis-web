...
import { IconArrowsMove, IconBrandGithub, IconDeviceMobile, IconLanguage, IconSearch } from '@tabler/icons-react';
      ...
      <section className={styles.languagesContainer} id="languages">
        <div className={styles.languages}>
          ...
          <div
            ...
            style={{
              borderColor: theme.colors.gray[colorMode === 'dark' ? 8 : 1],
            }}
          >
            {[...HYMNALS_CONFIG]
              .sort((a, b) => (a.title < b.title ? -1 : 1))
              .map((value) => (
                <Link key={value.key} className={styles.link} to={`/songs/${value.key}/1`}>
      ...
      <footer>
        <div className={styles.footerContents}>
          ...
          <div className={styles.icons}>
            <a href="https://github.com/Faith-UnFeigned/cis-web" target="_blank" rel="noopener noreferrer">
              <IconBrandGithub />
            </a>
          </div>
        </div>
